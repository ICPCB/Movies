...
- Phase 4 frontend (web/ React+Vite+Tailwind cinematic UI): NEXT
- Phase 5 speed pass, Phase 6 eval extension, Phase 7 intent parser (few-shot Ollama + LoRA on cinematch-llama/Llama-3.2-1B), Phase 8 final docs (README.md + PROJECT_OVERVIEW.md): PENDING
